...
jsonStringBooks =
  "[{\"borrower\":{\"name\":\"Borrower1\",\"maxBooks\":1},\"author\":\"Author1\",\"title\":\"Title1\"},{\"borrower\":null,\"author\":\"Author2\",\"title\":\"Title2\"}]"
...
main = hspec $ do
  describe "Borrower tests" $ do
    ...
    it "testSetMaxBooks" $ setMaxBooks 11 br1 `shouldBe` Borrower
      { name     = "Borrower1"
      , maxBooks = 11
      }
  ...
  describe "Book tests" $ do
    ...
    it "testGetBorrowerSomeone" $ getBorrower bk1 `shouldBe` Just Borrower
      { name     = "Borrower1"
      , maxBooks = 1
      }
    ...
    it "testSetBorrowerSomeone"
      ...
      `shouldBe` Book
                   { title    = "Title2"
                   , author   = "Author2"
                   , borrower = Just Borrower { name     = "BorrowerNew"
                                              , maxBooks = 111
                                              }
                   }

    it "testSetBorrowerNothing" $ setBorrower Nothing bk1 `shouldBe` Book
      { title    = "Title1"
      , author   = "Author1"
      , borrower = Nothing
      }
  ...
  describe "Library tests" $ do
    ...
    it "testCheckOutFailCheckedOut"
      ...
      `shouldBe` [ Book
                   { title    = "Title1"
                   , author   = "Author1"
                   , borrower = Just Borrower { name     = "Borrower1"
                                              , maxBooks = 1
                                              }
                   }
                 , Book { title    = "Title2"
    ...
    it "testCheckOutPass"
      ...
      `shouldBe` [ Book
                   { title    = "Title2"
                   , author   = "Author2"
                   , borrower = Just Borrower { name     = "Borrower3"
                                              , maxBooks = 3
                                              }
                   }
                 , Book
